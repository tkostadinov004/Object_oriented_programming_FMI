...
*Follow-up:* Подобна реализация на функцията partition, но връщаща индекса, при който е "границата", спрямо предиката, се използва в рекурсивния алгоритъм за сортиране
**quicksort**.
