...
По желание да се реализират и други конструктори, като е желателно да се добавят и гетъри и сетъри (в които трябва да валидирате входните данни, хвърляйки подходящи изключения, в случай на невалидни данни) за собствените полета на класа.

Класът ```Bicycle``` може да бъде записван във файл, но не може да бъде четен. Класът ```Car``` може да бъде и записван, и четен във файл. Реализирайте класове *Reader* и *Writer*, които се
грижат съответно за четенето от файл и записването във файл на произволен обект. 
</br> </br>
